...
public:
  ...
  /**
   * \param originalID of the packet;
   */
  void SetOriginalId(Ipv4Address originalID);
  /**
 ...
 * get the original ID
 */
  Ipv4Address GetOriginalID(void) const;
  /**
...
private:
  ...
  Ipv4Address m_originalID;  //!< originalID  add by Tao
