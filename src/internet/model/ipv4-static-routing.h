 ...
 */
  ...
  /**
   * method to create locallist
   */
  void AddNeighborRoute(Ipv4InterfaceAddress local,Ipv4InterfaceAddress neighbor);
...
private:
  ...
  ///Container for the local list add by tao
  typedef std::list<std::pair<Ipv4InterfaceAddress ,Ipv4InterfaceAddress  > > Locallist;
  ///Const Iterator for container for locallist by tao
  typedef std::list<std::pair<Ipv4InterfaceAddress ,Ipv4InterfaceAddress >  >::const_iterator LocallistCI;
  //Iterator for container for the network routes
  typedef std::list<std::pair<Ipv4InterfaceAddress , Ipv4InterfaceAddress > >::iterator LocallistI;

  typedef std::list<std::pair<Ipv4Address,Ipv4Address> > Hrt;
  typedef std::list<std::pair<Ipv4Address,Ipv4Address> >::const_iterator HrtlistCI;
  typedef std::list<std::pair<Ipv4Address,Ipv4Address> >::iterator HrtlistI;
  /**
  ...
  Locallist  locallist;    //changeByTao
  /**
