...
void
Ipv4Route::SetNewSource(Ipv4Address lsource)
{
	  NS_LOG_FUNCTION(this<<lsource);
	  newsource=lsource;
}
Ipv4Address
Ipv4Route::GetNewSource(void) const
{
	NS_LOG_FUNCTION(this);
	return newsource;
}
void
Ipv4Route::SetMetric(uint32_t metric)
{
   NS_LOG_FUNCTION(this<<metric);
   shortest_metric=metric;
}
uint32_t
Ipv4Route::GetMetric(void) const
{
	 NS_LOG_FUNCTION(this);
	 return shortest_metric;
}
void
...
void
Ipv4Route::SetOldSource(Ipv4Address osource)
{
	m_oldsource=osource;
}
Ipv4Address
Ipv4Route::GetOldSource(void) const
{
     NS_LOG_FUNCTION(this);
     return m_oldsource;
}
void
Ipv4Route::SetOffset(int a)
{
	 m_offset=a;
}
uint32_t
Ipv4Route::GetOffSet(void) const
{
	return m_offset;
}
void
