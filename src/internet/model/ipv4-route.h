...
public:
   ...
   * set localsource
   */
  void SetNewSource(Ipv4Address lsource);
  /**
   *  return localsource
   */
  Ipv4Address GetNewSource(void) const;
  /**
   * set oldsource
   */
  void SetOldSource(Ipv4Address osource);
  /**
   * get oldsource
   */
  Ipv4Address GetOldSource(void) const;
  /*
   * set offset
   */
...
private:
  ...
  uint32_t shortest_metric;       //!hop count add by Tao
  Ipv4Address newsource;        //localsource add by Tao
  Ipv4Address m_oldsource;         //oldsource add by Tao
  int  m_offset;            //offset add by Tao
#ifdef NOTYET
